...
import { 
  ...
  Linkedin, Facebook, Instagram, Youtube, Menu, X, FileText
} from 'lucide-react';
...
const Services: React.FC<ServicesProps> = ({ onNavigateHome, onNavigateAbout, onNavigateContact, onNavigateTraining, isBrochureModalOpen, setIsBrochureModalOpen }) => {
