...
import { Mail, Phone, MapPin, CheckCircle, BarChart3, Brain, Users, Zap, ArrowRight, Star, TrendingUp, Linkedin, Twitter, Instagram, Youtube } from 'lucide-react';
...
const Home: React.FC<HomeProps> = ({ onNavigateAbout, onNavigateContact, onNavigateTraining, onNavigateServices }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-900 overflow-x-hidden">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-left space-y-8">
              <div className={`transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
                ...
                <h2 className="text-4xl md:text-6xl font-bold text-orange-500 mb-6 leading-tight">
                  <span className="relative inline-block">
                    {typingText}
                    {typingIndex < "AI Data Analyst.".length && (
                      <span className="inline-block w-0.5 h-12 bg-orange-500 ml-1 animate-pulse"></span>
                    )}
                  </span>
                </h2>
              </div>
              ...
              <div className={`flex flex-col sm:flex-row gap-4 transform transition-all duration-1000 delay-500 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
                <button onClick={onNavigateContact} className="group bg-orange-600 text-white px-8 py-4 rounded-lg font-semibold hover:bg-orange-700 transition-all duration-300 hover:scale-105 hover:shadow-lg flex items-center justify-center">
                  Get Started
                  <ArrowRight className="ml-2 w-4 h-4 transform group-hover:translate-x-1 transition-transform duration-300" />
                </button>
                <button onClick={() => scrollToSection('services')} className="group border-2 border-gray-600 text-gray-300 px-8 py-4 rounded-lg font-semibold hover:bg-gray-800 hover:border-orange-500 transition-all duration-300 hover:scale-105 hover:shadow-lg">
                  Learn More
                </button>
              </div>
            </div>
            ...
            <div className={`transform transition-all duration-1000 delay-700 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
              <div className="relative">
                {/* Quote */}
                <div className="absolute -top-52 left-1/2 transform -translate-x-1/2 z-20 text-center">
                  <div 
                    className="group bg-gray-800/80 backdrop-blur-sm border border-orange-500/30 rounded-lg px-8 py-3 shadow-lg min-w-max relative overflow-hidden cursor-pointer hover:scale-105 transition-all duration-500 hover:border-orange-500"
                    style={{
      ...
      {/* Stats Section */}
      <section id="stats-section" className="py-16 bg-gray-800">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => {
              ...
              return (
                ...
                >
                  <div className="bg-gray-700 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 hover:bg-orange-600 transition-colors duration-300">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {services.map((service, index) => {
              ...
              return (
                <div 
                  key={index}
                  className="group bg-gray-800 p-8 rounded-xl border border-gray-700 hover:shadow-xl hover:shadow-orange-500/20 transition-all duration-500 hover:-translate-y-2 cursor-pointer hover:border-orange-500 relative"
                >
                  ...
                  <div className="bg-gray-700 w-16 h-16 rounded-lg flex items-center justify-center mb-6 group-hover:bg-orange-600 group-hover:scale-110 transition-all duration-300">
                    <IconComponent className="w-8 h-8 text-orange-500 group-hover:text-white transition-colors duration-300" />
                  </div>
      ...
      {/* Training Section */}
      <section id="training" className="py-20 bg-gray-800 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-orange-900/10 to-transparent"></div>
        <div className="max-w-6xl mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            <h3 className="text-3xl md:text-4xl font-bold text-white mb-4">AI Analytics Training Programs</h3>
            <p className="text-gray-400 max-w-2xl mx-auto text-lg">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gray-700 p-8 rounded-xl border border-gray-600 hover:border-orange-500 transition-all duration-500 hover:shadow-xl hover:shadow-orange-500/20 group">
              <div className="bg-orange-600 w-16 h-16 rounded-lg flex items-center justify-center mb-6 group-hover:scale-110 transition-all duration-300">
                <Brain className="w-8 h-8 text-white" />
              </div>
              <h4 className="text-xl font-semibold text-white mb-4">Vibe Analytics</h4>
              <p className="text-gray-400 mb-4">Advanced course on vibe analytics, data preprocessing, and AI models.</p>
              <div className="text-orange-500 font-medium">Duration: 2 weeks</div>
            </div>
            ...
            <div className="bg-gray-700 p-8 rounded-xl border border-gray-600 hover:border-orange-500 transition-all duration-500 hover:shadow-xl hover:shadow-orange-500/20 group">
              ...
              <h4 className="text-xl font-semibold text-white mb-4">Data Analytics & AI</h4>
              <p className="text-gray-400 mb-4">Learn the basics of data analytics, data preprocessing, and AI models.</p>
              <div className="text-orange-500 font-medium">Duration: 6 weeks</div>
            </div>
            ...
            <div className="bg-gray-700 p-8 rounded-xl border border-gray-600 hover:border-orange-500 transition-all duration-500 hover:shadow-xl hover:shadow-orange-500/20 group">
              ...
              <h4 className="text-xl font-semibold text-white mb-4">Prompting & AI Tools</h4>
              <p className="text-gray-400 mb-4">Transform data into actionable insights with effective AI prompting.</p>
              <div className="text-orange-500 font-medium">Duration: 2 weeks</div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-4 relative z-10">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <h3 className="text-3xl md:text-4xl font-bold text-white mb-8">About ARIS</h3>
              ...
              <div className="flex flex-wrap gap-6 pt-4">
                <div className="flex items-center group cursor-pointer">
                  ...
                  <span className="text-gray-300 group-hover:text-white transition-colors duration-300">Expert AI Engineers</span>
                </div>
                <div className="flex items-center group cursor-pointer">
                  <CheckCircle className="w-5 h-5 text-green-500 mr-3 group-hover:scale-110 transition-transform duration-300" />
                  <span className="text-gray-300 group-hover:text-white transition-colors duration-300">Custom Solutions</span>
                </div>
                <div className="flex items-center group cursor-pointer">
                  <CheckCircle className="w-5 h-5 text-green-500 mr-3 group-hover:scale-110 transition-transform duration-300" />
                  <span className="text-gray-300 group-hover:text-white transition-colors duration-300">Proven Results</span>
                </div>
              </div>
            </div>
            <div className="relative">
              <div className="bg-gradient-to-br from-gray-800 to-gray-700 rounded-2xl p-8 transform hover:scale-105 transition-all duration-500 hover:shadow-xl border border-gray-600">
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-gray-900 rounded-lg p-4 hover:bg-orange-600 transition-colors duration-300 group">
                    <div className="text-2xl font-bold text-orange-500 group-hover:text-white transition-colors duration-300">25+</div>
                    <div className="text-sm text-gray-400 group-hover:text-white transition-colors duration-300">Years Experience</div>
                  </div>
                  <div className="bg-gray-900 rounded-lg p-4 hover:bg-orange-600 transition-colors duration-300 group">
                    <div className="text-2xl font-bold text-orange-500 group-hover:text-white transition-colors duration-300">100+</div>
                    <div className="text-sm text-gray-400 group-hover:text-white transition-colors duration-300">AI Models</div>
                  </div>
                  <div className="bg-gray-900 rounded-lg p-4 hover:bg-orange-600 transition-colors duration-300 group">
                    <div className="text-2xl font-bold text-orange-500 group-hover:text-white transition-colors duration-300">24/7</div>
                    <div className="text-sm text-gray-400 group-hover:text-white transition-colors duration-300">Support</div>
                  </div>
                  <div className="bg-gray-900 rounded-lg p-4 hover:bg-orange-600 transition-colors duration-300 group">
                    <div className="text-2xl font-bold text-orange-500 group-hover:text-white transition-colors duration-300">Monthly</div>
                    <div className="text-sm text-gray-400 group-hover:text-white transition-colors duration-300">Physical Meetup</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-12">
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-center group hover:bg-gray-700 hover:shadow-md rounded-lg p-4 transition-all duration-300 cursor-pointer">
                    <div className="bg-gray-700 p-3 rounded-lg mr-4 group-hover:bg-orange-600 transition-colors duration-300">
                      <Mail className="w-5 h-5 text-orange-500 group-hover:text-white transition-colors duration-300" />
                    </div>
                    <div>
                      <div className="font-medium text-white">Email</div>
                      <div className="text-gray-400">info@aris-ai.com</div>
                    </div>
                  </div>
                  <div className="flex items-center group hover:bg-gray-700 hover:shadow-md rounded-lg p-4 transition-all duration-300 cursor-pointer">
                    <div className="bg-gray-700 p-3 rounded-lg mr-4 group-hover:bg-orange-600 transition-colors duration-300">
              ...
              {/* Contact Form */}
              <div className="bg-gray-800 rounded-2xl p-8 shadow-lg hover:shadow-xl border border-gray-700 transition-shadow duration-500">
                {/* Status Messages */}
                {formStatus === 'success' && (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="group">
                    ...
                    <input
                      ...
                      required
                      className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-300 hover:border-orange-400 bg-gray-700 text-white placeholder-gray-400 ${
                  ...
                  <div className="group">
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className="w-full px-4 py-3 border border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-300 hover:border-orange-400 bg-gray-700 text-white placeholder-gray-400"
                    />
                  </div>
                  ...
                  <div className="group">
                    ...
                    <textarea
                      ...
                      required
                      rows={4}
                      className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-300 hover:border-orange-400 resize-none bg-gray-700 text-white placeholder-gray-400 ${
                  ...
                  <button
                    ...
                    className={`w-full py-4 px-6 rounded-lg font-semibold transition-all duration-300 hover:scale-105 hover:shadow-lg group flex items-center justify-center ${
